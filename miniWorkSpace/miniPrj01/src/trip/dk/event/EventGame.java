...
public class EventGame {
	...
	public int rpsGame() {
		...
		int com = 0;
			...
			for(int i = 0;i<5;i++) {
				...
				if(user<4&&user>0) {
					switch(user-com){
					case 2:
						case-1 : System.out.println(MemberMain.LoginMember.getNick()+"님이 졌습니다.");
						break;
					case 1:
						case-2 : System.out.println(MemberMain.LoginMember.getNick()+"님이 이겼습니다.");
						userCnt++;
						break;
					case 0:
		...
		System.out.println(MemberMain.LoginMember.getNick()+"님의 승리한 횟수 : " +userCnt);
